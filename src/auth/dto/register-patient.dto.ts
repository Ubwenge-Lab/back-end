...
export class RegisterPatientDto {
  ...
  @ApiProperty({ required: false, description: 'GPS latitude of patient home location' })
  @IsNumber()
  @IsOptional()
  latitude?: number;

  @ApiProperty({ required: false, description: 'GPS longitude of patient home location' })
  @IsNumber()
  @IsOptional()
  longitude?: number;
}
