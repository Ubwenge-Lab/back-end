...
import { IsString, IsEmail, IsNotEmpty, IsNumber, IsDateString, Min, Max } from 'class-validator';
...
export class RegisterPharmacyDto {
  ...
  @ApiProperty({ description: 'GPS latitude of pharmacy location, must be between -90 and 90 (required)' })
  @IsNotEmpty()
  @IsNumber()
  @Min(-90)
  @Max(90)
  ...
  @ApiProperty({ description: 'GPS longitude of pharmacy location, must be between -180 and 180 (required)' })
  @IsNotEmpty()
  @IsNumber()
  @Min(-180)
  @Max(180)
