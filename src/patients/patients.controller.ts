...
@Get(':mrn/medical-history')
  ...
  @ApiOperation({ summary: 'Get complete medical history aggregated and paginated by Patient MRN' })
  ...
  getMasterHistory(
    ...
    return this.patientsService.getMasterMedicalHistory(mrn, req.user, page, limit);
  }
}
